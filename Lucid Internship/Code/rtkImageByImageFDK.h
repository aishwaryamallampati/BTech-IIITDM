...
#ifndef rtkImageByImageFDK_h
#define rtkImageByImageFDK_h
...
namespace rtk
{
	...
	* - itk::ExtractImageFilter which is used in FDKConeBeamReconstructionFilter
	* is removed as there is no need to extract sub stacks of input, just one input projection
	...
	*/
	template<class TInputImage, class TOutputImage, class TFFTPrecision = double>
	class ITK_EXPORT ImageByImageFDK :
		public itk::InPlaceImageFilter<TInputImage, TOutputImage>
	{
	public:
		/** Standard class typedefs. */
		typedef ImageByImageFDK                    Self;
		...
		typedef rtk::FDKWeightProjectionFilter<InputImageType, InputImageType>          WeightFilterType;
		...
		itkTypeMacro(ImageByImageFDK, itk::ImageToImageFilter);
...
#include "rtkImageByImageFDK.hxx"
#endif
